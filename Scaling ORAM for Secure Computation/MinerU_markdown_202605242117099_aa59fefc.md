...
<table><tr><td></td><td colspan="4">Access</td></tr><tr><td></td><td>Floram</td><td>Florom</td><td>Square-root</td><td>Circuit</td></tr><tr><td>Secure Computation</td><td><eq>O(\sqrt{n})</eq></td><td><eq>O(\log n)</eq></td><td><eq>O(\sqrt{n\log^{3}n})</eq></td><td><eq>O(\log^{3}n)</eq></td></tr><tr><td>Local Computation</td><td><eq>O(n)</eq></td><td><eq>O(n)</eq></td><td><eq>O(\sqrt{n\log n})</eq></td><td><eq>O(1)</eq></td></tr><tr><td>Communication</td><td><eq>O(\sqrt{n})</eq></td><td><eq>O(\log n)</eq></td><td><eq>O(\sqrt{n\log^{3}n})</eq></td><td><eq>O(\log^{3}n)</eq></td></tr><tr><td>Rounds</td><td><eq>O(1)</eq></td><td><eq>O(1)</eq></td><td><eq>O(\log n)</eq></td><td><eq>O(\log n)</eq></td></tr></table>

<table><tr><td></td><td colspan="4">Initialization</td></tr><tr><td></td><td>Floram</td><td>Florom</td><td>Square-root</td><td>Circuit</td></tr><tr><td>Secure Computation</td><td>-</td><td>-</td><td><eq>O(n \log^2 n)</eq></td><td><eq>O(n \log^3 n)</eq></td></tr><tr><td>Local Computation</td><td><eq>O(n)</eq></td><td><eq>O(n)</eq></td><td><eq>O(n \log n)</eq></td><td><eq>O(1)</eq></td></tr><tr><td>Communication</td><td><eq>O(n)</eq></td><td><eq>O(n)</eq></td><td><eq>O(n \log^2 n)</eq></td><td><eq>O(n \log^3 n)</eq></td></tr><tr><td>Rounds</td><td><eq>O(1)</eq></td><td><eq>O(1)</eq></td><td><eq>O(\log n)</eq></td><td><eq>O(n \log n)</eq></td></tr></table>
...
<table><tr><td>n</td><td>s</td><td>Linear</td><td>Circuit</td><td>Square-root</td><td>Floram</td><td>CPRG</td></tr><tr><td rowspan="3"><eq>2^{15}</eq></td><td>1</td><td>2.80</td><td>5192.4</td><td>12.87</td><td>0.79</td><td>0.37</td></tr><tr><td><eq>2^5</eq></td><td>89.75</td><td>5284.2</td><td>37.24</td><td>23.73</td><td>11.15</td></tr><tr><td><eq>2^{10}</eq></td><td>2872.1</td><td>8126.8</td><td>1210.0</td><td>758.89</td><td>358.0</td></tr><tr><td rowspan="3"><eq>2^{20}</eq></td><td>1</td><td>89.52</td><td>-</td><td>690.99</td><td>2.04</td><td>0.99</td></tr><tr><td><eq>2^5</eq></td><td>2864.5</td><td>-</td><td>800.23</td><td>56.94</td><td>21.94</td></tr><tr><td><eq>2^{10}</eq></td><td>91,663.</td><td>-</td><td>12,736.</td><td>1826.5</td><td>697.65</td></tr><tr><td><eq>2^{25}</eq></td><td>1</td><td>2864.5</td><td>-</td><td>-</td><td>14.37</td><td>11.55</td></tr></table>
